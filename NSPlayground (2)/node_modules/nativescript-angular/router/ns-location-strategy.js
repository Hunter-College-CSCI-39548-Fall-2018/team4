...
var Outlet = /** @class */ (function () {
    function Outlet(outletKey, pathByOutlets, modalNavigationDepth) {
        this.states = [];
...
var NSLocationStrategy = /** @class */ (function (_super) {
    ...
    NSLocationStrategy.prototype.path = function () {
        ...
        var changedOutlet = this.getSegmentGroup(this.currentOutlet.pathByOutlets);
    ...
    NSLocationStrategy.prototype.pushStateInternal = function (state, title, url, queryParams) {
        ...
        if (!Object.keys(urlTreeRoot.children).length) {
            ...
            var outletKey = this.getSegmentGroupFullPath(segmentGroup) + "primary";
            var outlet = this.findOutletByKey(outletKey);
            if (outlet && this.updateStates(outlet, segmentGroup)) {
                this.currentOutlet = outlet; // If states updated
            }
            else if (!outlet) {
                var rootOutlet = this.createOutlet("primary", segmentGroup, null);
        ...
        while (currentTree) {
            Object.keys(currentTree.children).forEach(function (outletName) {
                ...
                var outletKey = _this.getSegmentGroupFullPath(currentTree) + outletName;
                var outlet = _this.findOutletByKey(outletKey);
                var parentOutletName = currentTree.outlet || "";
                var parentOutletKey = _this.getSegmentGroupFullPath(currentTree.parent) + parentOutletName;
                ...
                if (!outlet) {
                    ...
                    outlet = _this.createOutlet(outletKey, currentSegmentGroup, parentOutlet, _this._modalNavigationDepth);
    ...
    NSLocationStrategy.prototype.callPopState = function (state, pop, outlet) {
        ...
        outlet = outlet || this.currentOutlet;
        var urlSerializer = new router_1.DefaultUrlSerializer();
        var changedOutlet = this.getSegmentGroup(outlet.pathByOutlets);
    ...
    NSLocationStrategy.prototype.clearOutlet = function (frame) {
        ...
        this.outlets = this.outlets.filter(function (currentOutlet) {
            ...
            var isEqualToCurrent = currentOutlet.pathByOutlets === _this.currentOutlet.pathByOutlets;
            var isModalOutlet = currentOutlet.modalNavigationDepth > 0;
    ...
    NSLocationStrategy.prototype.createOutlet = function (outletKey, segmentGroup, parent, modalNavigation) {
        var pathByOutlets = this.getPathByOutlets(segmentGroup);
        var newOutlet = new Outlet(outletKey, pathByOutlets, modalNavigation);
        var locationState = {
    ...
    NSLocationStrategy.prototype.getSegmentGroup = function (pathByOutlets) {
        var pathList = pathByOutlets.split("-");
    ...
    NSLocationStrategy.prototype.upsertModalOutlet = function (parentOutlet, segmentedGroup) {
        ...
        if (!currentModalOutlet) {
            ...
            var outletKey = parentOutlet.peekState().segmentGroup.toString() + outletName;
