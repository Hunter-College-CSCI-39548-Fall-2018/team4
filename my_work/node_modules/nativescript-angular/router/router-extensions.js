...
var RouterExtensions = /** @class */ (function () {
    ...
    RouterExtensions.prototype.findOutletsToBack = function (options) {
        ...
        var relativeRoute = options.relativeTo;
        ...
        var _loop_1 = function (index) {
            var currentRoute = relativeRoute.children[index];
            if (outlets.some(function (currentOutlet) { return currentOutlet === currentRoute.outlet; })) {
                ...
                var outletKey = this_1.locationStrategy.getRouteFullPath(currentRouteSnapshop);
                var outlet = this_1.locationStrategy.findOutletByKey(outletKey);
                if (outlet) {
        ...
        var this_1 = this;
        for (var index = 0; index < relativeRoute.children.length; index++) {
            _loop_1(index);
        }
