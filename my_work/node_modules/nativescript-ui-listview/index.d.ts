...
/**
 * Used internally by the nativescript-ui-listview plugin's Angular directvies.
 */
export const NG_VIEW: string;
...
export class RadListView extends View {
    ...
    */
    ...
    /**
     * Used internally inside the Angular directives
    ...
    /**
     * Used internally inside the Angular directives
     * Called when the refresh function is called.
     */
    itemViewDisposer: () => void;

    /**
     * Used internally inside the Angular directives
     * Called when the wrapper StackLayout of the itemTemplate is added to the RadListView.
     */
