...
var RadListView = /** @class */ (function (_super) {
    ...
    RadListView.prototype.syncListViewLayout = function (newValue) {
        ...
        if (newLayout && this.nativeViewProtected) {
            ...
            this.updateHeaderFooter();
            this.nativeViewProtected.cellSwipeLimits = (newLayout.scrollDirection === "Horizontal") ? UIEdgeInsetsFromString("{60, 0, 60, 0}") : UIEdgeInsetsFromString("{0, 60, 0, 60}");
        }
    };
        ...
        if (this.nativeViewProtected) {
            ...
            if (style) {
                if (style.indicatorColor) {
                    this.nativeViewProtected.pullToRefreshView.activityIndicator.color = new colorModule.Color(style.indicatorColor).ios;
                }
                if (style.indicatorBackgroundColor) {
                    this.nativeViewProtected.pullToRefreshView.activityIndicator.backgroundColor = new colorModule.Color(style.indicatorBackgroundColor).ios;
                }
            }
        }
    };
    ...
    RadListView.prototype.scrollToIndex = function (index, animate, snapMode) {
        ...
        if (this.nativeViewProtected) {
            ...
            this.nativeViewProtected.scrollToItemAtIndexPathAtScrollPositionAnimated(NSIndexPath.indexPathForItemInSection(index, 0), snapPosition, animate);
        }
    };
